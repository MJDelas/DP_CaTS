...
genecolData_first <- genecolData_first %>% 
  separate(Sample_ID,into=c("Day","Condition","Gate"), sep="_", remove=FALSE) 
#%>%
...
vsd_pca_plot <- vsd_pca$x %>% 
  ...
  separate(Sample,into=c("Day","Condition","Gate"), sep="_", remove=FALSE)
%>%
  mutate(Condition=paste(Genotype,Day,Gate,NFIAgate, sep="_"),
...
ggplot(vsd_pca_plot, aes(x=PC1,y=PC2,fill=Rep,shape=Genotype, label=Condition)) +
  geom_point(size=4, alpha=0.9) +
...
ggplot(vsd_pca_plot, aes(x=PC1,y=PC2,fill=Genotype,shape=NFIAgate)) +
  geom_point(size=4, alpha=0.9) +
  guides(fill = guide_legend(override.aes=list(shape=21))) +
  scale_shape_manual(values = shapes4_fill_manual) +
  labs(x=paste0("PC1: ",round(var_explained[1]*100,1),"%"),
...
ggplot(vsd_pca_plot, aes(x=PC1,y=PC3,fill=Gate,shape=NFIAstatus)) +
  scale_fill_manual(values = colorIZ[4:7]) +
  geom_point(size=4, alpha=0.9) +
  guides(fill = guide_legend(override.aes=list(shape=21))) +
  scale_shape_manual(values = shapes5_manual) +
...
ggplot(vsd_pca_plot, aes(x=PC2,y=PC3,fill=Gate,shape=NFIAstatus)) +
  scale_fill_manual(values = colorIZ[4:7]) +
  geom_point(size=4, alpha=0.9) +
  guides(fill = guide_legend(override.aes=list(shape=21))) +
  scale_shape_manual(values = shapes5_manual) +
...
ggplot(vsd_pca_plot, aes(x=PC1,y=PC3,fill=Rep,shape=Genotype, label=Condition)) +
  geom_point(size=4, alpha=0.9) +
  #geom_text(nudge_x = 5) +
  guides(fill = guide_legend(override.aes=list(shape=21))) +
  scale_shape_manual(values = shapes4_fill_manual) +
...
ggplot(vsd_pca_plot, aes(x=PC1,y=PC3,fill=Day,shape=NFIAstatus)) +
#  scale_fill_manual(values = colorIZ) +
  geom_point(size=4, alpha=0.9) +
  guides(fill = guide_legend(override.aes=list(shape=21))) +
  scale_shape_manual(values = shapes5_manual) +
...
ggplot(vsd_pca_plot, aes(x=PC4,y=PC2,fill=DayGate,shape=NFIAstatus)) +
  scale_fill_manual(values = colorIZ) +
  geom_point(size=4, alpha=0.9) +
  guides(fill = guide_legend(override.aes=list(shape=21))) +
  scale_shape_manual(values = shapes5_manual) +
...
ggplot(vsd_pca_plot, aes(x=PC4,y=PC2,fill=Rep,shape=Genotype, label=Condition)) +
  geom_point(size=4, alpha=0.9) +
  #geom_text(nudge_x = 5) +
  guides(fill = guide_legend(override.aes=list(shape=21))) +
  scale_shape_manual(values = shapes4_fill_manual) +
...
ggplot(vsd_pca_plot, aes(x=PC4,y=PC5,fill=DayGate,shape=NFIAstatus)) +
  scale_fill_manual(values = colorIZ) +
  geom_point(size=4, alpha=0.9) +
  guides(fill = guide_legend(override.aes=list(shape=21))) +
  scale_shape_manual(values = shapes5_manual) +
...
ggplot(vsd_pca_plot, aes(x=PC4,y=PC5,fill=Rep,shape=Genotype, label=Condition)) +
  geom_point(size=4, alpha=0.9) +
  #geom_text(nudge_x = 5) +
  guides(fill = guide_legend(override.aes=list(shape=21))) +
  scale_shape_manual(values = shapes4_fill_manual) +
...
dds_counts_plot <- dds_counts %>% 
  ...
  separate(sampleid,into=c("Day","Condition","Gate"), sep="_", remove=FALSE) %>%
...
geneOI <- c("Sox2","Olig2","Nkx2-2","Nkx6-1","Sim1","Mnx1","Pax6","Irx3","Dbx1","Dbx2","Foxa2","Shh","Tubb3","Arx")
...
ggplot(dds_counts_plot %>% filter(geneid %in% geneOI), 
  ...
  geom_point(aes(fill=Condition), alpha=0.9, position = position_dodge(width = 0.7),color="black") +
