...
![](DPpilotRNA_2_quick_plotgenes_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
![](DPpilotRNA_2_quick_plotgenes_files/figure-gfm/unnamed-chunk-10-2.png)<!-- -->
...
![](DPpilotRNA_2_quick_plotgenes_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
![](DPpilotRNA_2_quick_plotgenes_files/figure-gfm/unnamed-chunk-13-2.png)<!-- -->
...
![](DPpilotRNA_2_quick_plotgenes_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
![](DPpilotRNA_2_quick_plotgenes_files/figure-gfm/unnamed-chunk-14-2.png)<!-- -->

``` r
geneOI <- c("Gdf11","Mstn","Bmp1","Gdf2","Bmp8b","Bmp15","Bmp2","Nodal","Gfd10","Inhba","Inhbc","Gdf9","Gdf5","Bmp4","Gdf15","Gdf7","Bmp5","Bmp8a","Tgfb1","Bmp7","Lefty2","Gdf3","Gdf1","Lefty1","Inhbe","Inha","Gdf6","Bmp10","Tgfb3","Bmp6","Bmp3","Tgfb2","Inhbb","Fst")
...
![](DPpilotRNA_2_quick_plotgenes_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->

``` r
geneOI <- c("Gdf11","Bmp1","Tgfb2","Tgfb3","Bmp7")
...
ggplot(dds_counts_plot %>% filter(geneid %in% geneOI & Condition %in% c("500","UPSAG","dRA2UPSAG")) %>%
  ...
  #scale_color_manual(values=color_gates) +
  scale_shape_manual(values=shapes4_fill_manual) +
  facet_wrap(Condition ~ geneid, scales = "free_y", nrow=3) +
  theme_bw()
```

![](DPpilotRNA_2_quick_plotgenes_files/figure-gfm/unnamed-chunk-15-2.png)<!-- -->
